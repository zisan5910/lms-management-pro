  ...
  const downloadTemplate = () => {
    const template = [
      ...
      },
      {
        ...
        questionImage: "https://example.com/photo.jpg",
        type: "written",
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-start gap-2.5 bg-background/60 rounded-lg p-3 border border-border/50">
                ...
                <div className="space-y-1">
                  <p className="text-xs font-medium text-foreground">JSON টেমপ্লেট ডাউনলোড করুন, প্রশ্ন যোগ করুন, তারপর আপলোড করুন।</p>
                  <p className="text-[11px] text-muted-foreground leading-relaxed">
                    Written-এ ফিল্ড: <code className="bg-accent px-1 py-0.5 rounded text-primary text-[10px]">question, questionImage, answerImage, marks</code>
                  </p>
                </div>
              </div>
